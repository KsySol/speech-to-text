...
public class RusMain {
	...
	public RusMain() {
		...
		configuration.setAcousticModelPath("rus_acoustic/");
		configuration.setDictionaryPath("resource:/ru/ru.dic");
		configuration.setLanguageModelPath("resource:/ru/ru.lm");
		
		
		
		// граматика
		configuration.setGrammarPath("resource:/grammars");
		configuration.setGrammarName("grammarrus");
